<?php
  ...
  *----------------------------------*/
  ...
  function shows_count_up($atts){
    ...
    $output = "<div class='counter' data-start='$a[start]' data-count='$a[end]' data-decimals='$a[decimals]' data-duration='$a[duration]' data-scroll='$a[scroll]' data-easing='$a[easing]' data-grouping='$a[grouping]' data-separator='$a[separator]' data-decimal='$a[decimal]' data-prefix='$a[prefix]' data-suffix='$a[suffix]'></div>";
